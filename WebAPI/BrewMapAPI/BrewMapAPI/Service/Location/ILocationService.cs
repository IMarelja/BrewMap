...
namespace BrewMapAPI.Service.Location
{
    public interface ILocationService
    {
        ...
        Task<IEnumerable<ReadLocation>> SearchAsync(string? query, double? minRating, string? drinkType, List<string>? paymentOptionTags, double? centerLatitude, double? centerLongitude, double radiusMeters);
    }
}
